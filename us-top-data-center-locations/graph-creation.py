...
ax2.plot(ax.get_xticks(),df['p_ak_com'], color='red',linewidth=3, label='$/kWh AK (Commercial)')

# Adjusting look of bar plot
ax.set_title('Source: Dgtl Infra (2023), EIA (2023)', fontsize=10, pad=35)
...
# Figure legend
fig.legend(loc=(0.15,.85), ncols=3, fancybox=False, framealpha=0) # hard coding location (not ideal)
